  ...
  return (
    ...
    <Link to='/'><img src={assets.logo} className='w-36' alt='Logo'/></Link>
     ...
     <div className='flex items-center gap-6'>
        ...
        <img onClick={()=> token ? null : navigate('/login')} src={assets.profileicon} className='w-5 cursor-pointer' alt=''/>
        {/* dropdown menu  */}
        {token &&  
        ...
        <p className='absolute right-[-5px] bottom-[-5px] w-4 text-center leading-4
         bg-black text-white aspect-sqaure rounded-full text-[8px]'>{getCartCount()}</p>
        </Link>
